...
#include "SEND_DV_FP.h"

#define TOS_FRAME_TYPE SEND_DV_FP_frame
TOS_FRAME_BEGIN(SEND_DV_FP_frame)
{
    char            pending;
    TOS_Msg         data;
}
TOS_FRAME_END(SEND_DV_FP_frame);
 ...
 */
char            TOS_COMMAND(SEND_DV_FP_QUERY_REPLY) (void *reply_msg) {
